...
//------------------------------------------------------------------//
			...
			html2 += '<div class="pull-right font-sm">' + $('#msg-wholesalePrice').val() + ' : <b class="font-bigger font-bold text-red">' + numberWithCommas(result.Price) + '</b></div>';
